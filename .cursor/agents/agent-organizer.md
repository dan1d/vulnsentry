...
- **rails-architect** - Rails application architect specializing in service-oriented design, Rails engines, domain-driven design patterns, and scalable Rails infrastructure for enterprise applications.
...
- **ruby-on-rails-pro** - Senior Rails developer specializing in MVC architecture, Active Record optimization, RESTful APIs, Hotwire, and Rails conventions for scalable web applications.
...
- **heroku-pro** - Heroku platform expert specializing in dyno management, buildpack configuration, add-ons ecosystem, and platform-native deployment strategies for scalable applications.
